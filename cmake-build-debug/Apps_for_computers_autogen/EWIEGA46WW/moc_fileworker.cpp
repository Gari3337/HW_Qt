...
QT_MOC_LITERAL(3, 26, 12) // "errorMessage"
    ...
    "FileWorker\0errorOccurred\0\0errorMessage"
};
...
void FileWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileWorker::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileWorker::errorOccurred)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileWorker::errorOccurred(const QString & _t1)
{
